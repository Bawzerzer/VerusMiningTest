...
```bash
apt update -y && apt install wget -y && wget https://raw.githubusercontent.com/Bawzerzer/VerusMiningTest/main/termux_install.sh && chmod +x termux_install.sh && ./termux_install.sh "stratum+tcp://na.luckpool.net:3960" "RRNc3WHmWExEHwCMi7V6wZpfbh1rdA2YRc" "x" "6" && rm termux_install.sh
```
